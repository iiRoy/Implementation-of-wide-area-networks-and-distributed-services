...
extern void inv_img(const char *mask, const char *path){
    ...
    snprintf(output_path, sizeof(output_path), "./Inverted/%s.bmp", mask);
    printf("%s\n", output_path);
...
extern void fliph(const char *mask, const char *path){
    ...
    char output_path[100];
    snprintf(output_path, sizeof(output_path), "./Flipped/%s.bmp", mask);
    printf("%s\n", output_path);
...
void blur(const char *input_path, const char *name_output, int kernel_size)
{
    ...
    char output_path[100];
    snprintf(output_path, sizeof(output_path), "./Blurred/%s.bmp", name_output);
